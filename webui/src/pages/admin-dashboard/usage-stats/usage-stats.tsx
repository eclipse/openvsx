...
import { Box, Alert, SelectChangeEvent } from "@mui/material";
import { useParams, useNavigate } from "react-router-dom";
import { MainContext } from "../../../context";
import type { UsageStats, UsageStatsPeriod, Customer } from "../../../extension-registry-types";
...
export const UsageStatsView: FC = () => {
    ...
    const [period, setPeriod] = useState<UsageStatsPeriod>('daily');
    ...
    }, [service, customer, startDate, endDate]);
    ...
    const handlePeriodChange = (event: SelectChangeEvent<UsageStatsPeriod>) => {
        setPeriod(event.target.value as UsageStatsPeriod);
    };
