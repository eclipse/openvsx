...
import { Box, Typography, Paper, type PaperProps, Chip, Stack, Divider, Grid } from '@mui/material';
        ...
        <Paper {...sectionPaperProps}>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6} md={4}>
                    ...
                    <Box sx={{ mt: 0.5 }}>
                        <Chip label={customer.state} size='small' color='secondary' />
                    </Box>
                </Grid>
                {tier ? (
                    <>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            ...
                            <Typography variant='body2'>
                                {tier.capacity} requests / {tier.duration}s
                            </Typography>
                        </Grid>
                        <Grid item xs={12} sm={6} md={4}>
                            <Typography variant='subtitle2' color='text.secondary'>
