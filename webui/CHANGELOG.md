...
- Add a Name Squatting section to the admin dashboard: it lists the extensions flagged by the name squatting publisher check, grouped per extension, and lets an administrator clear the findings as a false positive or soft delete an extension that is squatting a name
