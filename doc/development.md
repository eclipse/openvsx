...
- Install Elasticsearch with Docker
  ...
  - sudo docker pull elasticsearch:9.2.8
  - sudo docker run -d --name elasticsearch  -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" -e "xpack.ml.enabled=false" -e "xpack.security.enabled=false" elasticsearch:9.2.8
