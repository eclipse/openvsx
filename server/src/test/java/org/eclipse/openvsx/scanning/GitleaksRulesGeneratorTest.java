...
class GitleaksRulesGeneratorTest {
    ...
    void skipsGenerationWhenDisabled() {
        SecretScanningConfig config = buildConfig(false, false, null);
    ...
    void skipsGenerationWhenAutoGenerateDisabled() {
        SecretScanningConfig config = buildConfig(true, false, tempDir.resolve("rules.yaml").toString());
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void failsWhenAutoGenerateEnabledButPathNotConfigured() {
        SecretScanningConfig config = buildConfig(true, true, "");  // Empty path
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void failsWhenAutoGenerateEnabledButPathIsNull() {
        SecretScanningConfig config = buildConfig(true, true, null);  // Null path
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void createsParentDirectoryIfNotExists() throws Exception {
        ...
        SecretScanningConfig config = buildConfig(true, true, outputFile.toString());
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void failsWhenParentDirectoryCannotBeCreated() throws Exception {
        ...
        SecretScanningConfig config = buildConfig(true, true, impossiblePath.toString());
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void resolveOutputFileReturnsNullWhenPathNotConfigured() throws Exception {
        SecretScanningConfig config = buildConfig(true, true, "");
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    void acceptsRelativePath() throws Exception {
        ...
        SecretScanningConfig config = buildConfig(true, true, relativePath);
        GitleaksRulesGenerator generator = new GitleaksRulesGenerator(config);
    ...
    private SecretScanningConfig buildConfig(boolean enabled, boolean autoGenerate, String path) {
