...
public class TrustedPublishingService {
    ...
    public TrustedPublishingService(TrustedPublishingConfig config,
        ...
        if (config.isEnabled()) {
            this.providers = Map.of(
                    GitHubTrustedPublishingProvider.PROVIDER_ID, new GitHubTrustedPublishingProvider(config),
                    GitLabTrustedPublishingProvider.PROVIDER_ID, new GitLabTrustedPublishingProvider(config),
                    EclipseGitLabTrustedPublishingProvider.PROVIDER_ID, new EclipseGitLabTrustedPublishingProvider(config)
            );
        } else {
            this.providers = Map.of();
        }
