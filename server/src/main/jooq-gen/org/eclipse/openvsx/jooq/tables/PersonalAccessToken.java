...
public class PersonalAccessToken extends TableImpl<PersonalAccessTokenRecord> {
    ...
    private PersonalAccessToken(Name alias, Table<PersonalAccessTokenRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public PersonalAccessToken where(Condition condition) {
        return new PersonalAccessToken(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public PersonalAccessToken where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public PersonalAccessToken where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public PersonalAccessToken where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public PersonalAccessToken where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public PersonalAccessToken where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public PersonalAccessToken where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public PersonalAccessToken where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public PersonalAccessToken whereExists(Select<?> select) {
     ...
     */
    @Override
    public PersonalAccessToken whereNotExists(Select<?> select) {
