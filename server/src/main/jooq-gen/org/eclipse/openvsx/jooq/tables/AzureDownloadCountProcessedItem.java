...
public class AzureDownloadCountProcessedItem extends TableImpl<AzureDownloadCountProcessedItemRecord> {
    ...
    private AzureDownloadCountProcessedItem(Name alias, Table<AzureDownloadCountProcessedItemRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem where(Condition condition) {
        return new AzureDownloadCountProcessedItem(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public AzureDownloadCountProcessedItem where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public AzureDownloadCountProcessedItem where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public AzureDownloadCountProcessedItem where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public AzureDownloadCountProcessedItem where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem whereExists(Select<?> select) {
     ...
     */
    @Override
    public AzureDownloadCountProcessedItem whereNotExists(Select<?> select) {
