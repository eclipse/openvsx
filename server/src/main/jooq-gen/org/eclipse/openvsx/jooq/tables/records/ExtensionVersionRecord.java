...
public class ExtensionVersionRecord extends UpdatableRecordImpl<ExtensionVersionRecord> {
    ...
    /**
     * Setter for <code>public.extension_version.published_provenance</code>.
     */
    public void setPublishedProvenance(JSONB value) {
        set(41, value);
    }

    /**
     * Getter for <code>public.extension_version.published_provenance</code>.
     */
    public JSONB getPublishedProvenance() {
        return (JSONB) get(41);
    }
    ...
    public ExtensionVersionRecord(Long id, String bugs, String description, String displayName, String galleryColor, String galleryTheme, String homepage, String license, String markdown, Boolean preview, String qna, String repository, LocalDateTime timestamp, String version, Long extensionId, Long publishedWithId, Boolean active, String dependencies, String bundledExtensions, String engines, String categories, String tags, String extensionKind, Boolean preRelease, String targetPlatform, String localizedLanguages, String sponsorLink, Long signatureKeyPairId, Integer semverMajor, Integer semverMinor, Integer semverPatch, String semverPreRelease, Boolean semverIsPreRelease, String semverBuildMetadata, Boolean universalTargetPlatform, Boolean potentiallyMalicious, Boolean removed, LocalDateTime removedTimestamp, Long removedById, Long publishedById, String publishedWithTt, JSONB publishedProvenance) {
        ...
        setPublishedProvenance(publishedProvenance);
