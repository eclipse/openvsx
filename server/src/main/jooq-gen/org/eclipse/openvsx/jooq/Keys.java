...
public class Keys {
    ...
    public static final UniqueKey<ExtensionVersionChangeRecord> EXTENSION_VERSION_CHANGE_PKEY = Internal.createUniqueKey(ExtensionVersionChange.EXTENSION_VERSION_CHANGE, DSL.name("extension_version_change_pkey"), new TableField[] { ExtensionVersionChange.EXTENSION_VERSION_CHANGE.ID }, true);
    ...
    public static final UniqueKey<RateLimitTokenRecord> RATE_LIMIT_TOKEN_PKEY = Internal.createUniqueKey(RateLimitToken.RATE_LIMIT_TOKEN, DSL.name("rate_limit_token_pkey"), new TableField[] { RateLimitToken.RATE_LIMIT_TOKEN.ID }, true);
    ...
    public static final UniqueKey<SettingRecord> SETTING_KEY_UNIQUE = Internal.createUniqueKey(Setting.SETTING, DSL.name("setting_key_unique"), new TableField[] { Setting.SETTING.KEY }, true);
    public static final UniqueKey<SettingRecord> SETTING_PKEY = Internal.createUniqueKey(Setting.SETTING, DSL.name("setting_pkey"), new TableField[] { Setting.SETTING.ID }, true);
    ...
    public static final ForeignKey<CustomerMembershipRecord, CustomerRecord> CUSTOMER_MEMBERSHIP__CUSTOMER_MEMBERSHIP_CUSTOMER_FK = Internal.createForeignKey(CustomerMembership.CUSTOMER_MEMBERSHIP, DSL.name("customer_membership_customer_fk"), new TableField[] { CustomerMembership.CUSTOMER_MEMBERSHIP.CUSTOMER }, Keys.CUSTOMER_PKEY, new TableField[] { Customer.CUSTOMER.ID }, true);
    public static final ForeignKey<CustomerMembershipRecord, UserDataRecord> CUSTOMER_MEMBERSHIP__CUSTOMER_MEMBERSHIP_USER_DATA_FK = Internal.createForeignKey(CustomerMembership.CUSTOMER_MEMBERSHIP, DSL.name("customer_membership_user_data_fk"), new TableField[] { CustomerMembership.CUSTOMER_MEMBERSHIP.USER_DATA }, Keys.USER_DATA_PKEY, new TableField[] { UserData.USER_DATA.ID }, true);
    public static final ForeignKey<DailyUsageStatsRecord, CustomerRecord> DAILY_USAGE_STATS__DAILY_USAGE_STATS_CUSTOMER_FK = Internal.createForeignKey(DailyUsageStats.DAILY_USAGE_STATS, DSL.name("daily_usage_stats_customer_fk"), new TableField[] { DailyUsageStats.DAILY_USAGE_STATS.CUSTOMER_ID }, Keys.CUSTOMER_PKEY, new TableField[] { Customer.CUSTOMER.ID }, true);
    ...
    public static final ForeignKey<ExtensionVersionRecord, UserDataRecord> EXTENSION_VERSION__EXTENSION_VERSION_PUBLISHED_BY_ID_FKEY = Internal.createForeignKey(ExtensionVersion.EXTENSION_VERSION, DSL.name("extension_version_published_by_id_fkey"), new TableField[] { ExtensionVersion.EXTENSION_VERSION.PUBLISHED_BY_ID }, Keys.USER_DATA_PKEY, new TableField[] { UserData.USER_DATA.ID }, true);
    public static final ForeignKey<ExtensionVersionRecord, PersonalAccessTokenRecord> EXTENSION_VERSION__EXTENSION_VERSION_PUBLISHED_WITH_ID_FKEY = Internal.createForeignKey(ExtensionVersion.EXTENSION_VERSION, DSL.name("extension_version_published_with_id_fkey"), new TableField[] { ExtensionVersion.EXTENSION_VERSION.PUBLISHED_WITH_ID }, Keys.PERSONAL_ACCESS_TOKEN_PKEY, new TableField[] { PersonalAccessToken.PERSONAL_ACCESS_TOKEN.ID }, true);
    public static final ForeignKey<ExtensionVersionRecord, UserDataRecord> EXTENSION_VERSION__EXTENSION_VERSION_REMOVED_BY_ID_FKEY = Internal.createForeignKey(ExtensionVersion.EXTENSION_VERSION, DSL.name("extension_version_removed_by_id_fkey"), new TableField[] { ExtensionVersion.EXTENSION_VERSION.REMOVED_BY_ID }, Keys.USER_DATA_PKEY, new TableField[] { UserData.USER_DATA.ID }, true);
    ...
    public static final ForeignKey<ExtensionVersionChangeRecord, ExtensionVersionRecord> EXTENSION_VERSION_CHANGE__EXTENSION_VERSION_CHANGE_EXTENSION_VERSION_ID_FKEY = Internal.createForeignKey(ExtensionVersionChange.EXTENSION_VERSION_CHANGE, DSL.name("extension_version_change_extension_version_id_fkey"), new TableField[] { ExtensionVersionChange.EXTENSION_VERSION_CHANGE.EXTENSION_VERSION_ID }, Keys.EXTENSION_VERSION_PKEY, new TableField[] { ExtensionVersion.EXTENSION_VERSION.ID }, true);
    ...
    public static final ForeignKey<PersonalAccessTokenRecord, ExtensionRecord> PERSONAL_ACCESS_TOKEN__PERSONAL_ACCESS_TOKEN_SCOPE_EXTENSION_ID_FKEY = Internal.createForeignKey(PersonalAccessToken.PERSONAL_ACCESS_TOKEN, DSL.name("personal_access_token_scope_extension_id_fkey"), new TableField[] { PersonalAccessToken.PERSONAL_ACCESS_TOKEN.SCOPE_EXTENSION_ID }, Keys.EXTENSION_PKEY, new TableField[] { Extension.EXTENSION.ID }, true);
    public static final ForeignKey<PersonalAccessTokenRecord, NamespaceRecord> PERSONAL_ACCESS_TOKEN__PERSONAL_ACCESS_TOKEN_SCOPE_NAMESPACE_ID_FKEY = Internal.createForeignKey(PersonalAccessToken.PERSONAL_ACCESS_TOKEN, DSL.name("personal_access_token_scope_namespace_id_fkey"), new TableField[] { PersonalAccessToken.PERSONAL_ACCESS_TOKEN.SCOPE_NAMESPACE_ID }, Keys.NAMESPACE_PKEY, new TableField[] { Namespace.NAMESPACE.ID }, true);
    public static final ForeignKey<PersonalAccessTokenRecord, TrustedPublisherRecord> PERSONAL_ACCESS_TOKEN__PERSONAL_ACCESS_TOKEN_TRUSTED_PUBLISHER_ID_FKEY = Internal.createForeignKey(PersonalAccessToken.PERSONAL_ACCESS_TOKEN, DSL.name("personal_access_token_trusted_publisher_id_fkey"), new TableField[] { PersonalAccessToken.PERSONAL_ACCESS_TOKEN.TRUSTED_PUBLISHER_ID }, Keys.TRUSTED_PUBLISHER_PKEY, new TableField[] { TrustedPublisher.TRUSTED_PUBLISHER.ID }, true);
