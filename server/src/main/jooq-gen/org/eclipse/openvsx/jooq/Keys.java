...
public class Keys {
    ...
    public static final UniqueKey<ExtractResourcesMigrationItemRecord> EXTRACT_RESOURCES_MIGRATION_ITEM_PKEY = Internal.createUniqueKey(ExtractResourcesMigrationItem.EXTRACT_RESOURCES_MIGRATION_ITEM, DSL.name("extract_resources_migration_item_pkey"), new TableField[] { ExtractResourcesMigrationItem.EXTRACT_RESOURCES_MIGRATION_ITEM.ID }, true);
    public static final UniqueKey<ExtractResourcesMigrationItemRecord> UNIQUE_EXTENSION_ID = Internal.createUniqueKey(ExtractResourcesMigrationItem.EXTRACT_RESOURCES_MIGRATION_ITEM, DSL.name("unique_extension_id"), new TableField[] { ExtractResourcesMigrationItem.EXTRACT_RESOURCES_MIGRATION_ITEM.EXTENSION_ID }, true);
    ...
    public static final UniqueKey<QrtzJobChainsRecord> QRTZ_JOB_CHAINS_PKEY = Internal.createUniqueKey(QrtzJobChains.QRTZ_JOB_CHAINS, DSL.name("qrtz_job_chains_pkey"), new TableField[] { QrtzJobChains.QRTZ_JOB_CHAINS.SCHED_NAME, QrtzJobChains.QRTZ_JOB_CHAINS.CHAIN_NAME, QrtzJobChains.QRTZ_JOB_CHAINS.JOB1_NAME, QrtzJobChains.QRTZ_JOB_CHAINS.JOB1_GROUP, QrtzJobChains.QRTZ_JOB_CHAINS.JOB2_NAME, QrtzJobChains.QRTZ_JOB_CHAINS.JOB2_GROUP }, true);
    ...
    public static final UniqueKey<QrtzQueueRecord> QRTZ_QUEUE_PKEY = Internal.createUniqueKey(QrtzQueue.QRTZ_QUEUE, DSL.name("qrtz_queue_pkey"), new TableField[] { QrtzQueue.QRTZ_QUEUE.SCHED_NAME, QrtzQueue.QRTZ_QUEUE.QUEUE_NAME, QrtzQueue.QRTZ_QUEUE.JOB_NAME, QrtzQueue.QRTZ_QUEUE.JOB_GROUP }, true);
    ...
    public static final ForeignKey<QrtzBlobTriggersRecord, QrtzTriggersRecord> QRTZ_BLOB_TRIGGERS__QRTZ_BLOB_TRIGGERS_SCHED_NAME_FKEY = Internal.createForeignKey(QrtzBlobTriggers.QRTZ_BLOB_TRIGGERS, DSL.name("qrtz_blob_triggers_sched_name_fkey"), new TableField[] { QrtzBlobTriggers.QRTZ_BLOB_TRIGGERS.SCHED_NAME, QrtzBlobTriggers.QRTZ_BLOB_TRIGGERS.TRIGGER_NAME, QrtzBlobTriggers.QRTZ_BLOB_TRIGGERS.TRIGGER_GROUP }, Keys.QRTZ_TRIGGERS_PKEY, new TableField[] { QrtzTriggers.QRTZ_TRIGGERS.SCHED_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_GROUP }, true);
    public static final ForeignKey<QrtzCronTriggersRecord, QrtzTriggersRecord> QRTZ_CRON_TRIGGERS__QRTZ_CRON_TRIGGERS_SCHED_NAME_FKEY = Internal.createForeignKey(QrtzCronTriggers.QRTZ_CRON_TRIGGERS, DSL.name("qrtz_cron_triggers_sched_name_fkey"), new TableField[] { QrtzCronTriggers.QRTZ_CRON_TRIGGERS.SCHED_NAME, QrtzCronTriggers.QRTZ_CRON_TRIGGERS.TRIGGER_NAME, QrtzCronTriggers.QRTZ_CRON_TRIGGERS.TRIGGER_GROUP }, Keys.QRTZ_TRIGGERS_PKEY, new TableField[] { QrtzTriggers.QRTZ_TRIGGERS.SCHED_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_GROUP }, true);
    public static final ForeignKey<QrtzSimpleTriggersRecord, QrtzTriggersRecord> QRTZ_SIMPLE_TRIGGERS__QRTZ_SIMPLE_TRIGGERS_SCHED_NAME_FKEY = Internal.createForeignKey(QrtzSimpleTriggers.QRTZ_SIMPLE_TRIGGERS, DSL.name("qrtz_simple_triggers_sched_name_fkey"), new TableField[] { QrtzSimpleTriggers.QRTZ_SIMPLE_TRIGGERS.SCHED_NAME, QrtzSimpleTriggers.QRTZ_SIMPLE_TRIGGERS.TRIGGER_NAME, QrtzSimpleTriggers.QRTZ_SIMPLE_TRIGGERS.TRIGGER_GROUP }, Keys.QRTZ_TRIGGERS_PKEY, new TableField[] { QrtzTriggers.QRTZ_TRIGGERS.SCHED_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_GROUP }, true);
    public static final ForeignKey<QrtzSimpropTriggersRecord, QrtzTriggersRecord> QRTZ_SIMPROP_TRIGGERS__QRTZ_SIMPROP_TRIGGERS_SCHED_NAME_FKEY = Internal.createForeignKey(QrtzSimpropTriggers.QRTZ_SIMPROP_TRIGGERS, DSL.name("qrtz_simprop_triggers_sched_name_fkey"), new TableField[] { QrtzSimpropTriggers.QRTZ_SIMPROP_TRIGGERS.SCHED_NAME, QrtzSimpropTriggers.QRTZ_SIMPROP_TRIGGERS.TRIGGER_NAME, QrtzSimpropTriggers.QRTZ_SIMPROP_TRIGGERS.TRIGGER_GROUP }, Keys.QRTZ_TRIGGERS_PKEY, new TableField[] { QrtzTriggers.QRTZ_TRIGGERS.SCHED_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_NAME, QrtzTriggers.QRTZ_TRIGGERS.TRIGGER_GROUP }, true);
    public static final ForeignKey<QrtzTriggersRecord, QrtzJobDetailsRecord> QRTZ_TRIGGERS__QRTZ_TRIGGERS_SCHED_NAME_FKEY = Internal.createForeignKey(QrtzTriggers.QRTZ_TRIGGERS, DSL.name("qrtz_triggers_sched_name_fkey"), new TableField[] { QrtzTriggers.QRTZ_TRIGGERS.SCHED_NAME, QrtzTriggers.QRTZ_TRIGGERS.JOB_NAME, QrtzTriggers.QRTZ_TRIGGERS.JOB_GROUP }, Keys.QRTZ_JOB_DETAILS_PKEY, new TableField[] { QrtzJobDetails.QRTZ_JOB_DETAILS.SCHED_NAME, QrtzJobDetails.QRTZ_JOB_DETAILS.JOB_NAME, QrtzJobDetails.QRTZ_JOB_DETAILS.JOB_GROUP }, true);
