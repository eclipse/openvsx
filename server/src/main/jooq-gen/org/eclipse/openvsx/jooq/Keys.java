...
public class Keys {
    ...
    public static final ForeignKey<ExtensionRecord, ExtensionVersionRecord> EXTENSION__EXTENSION_LATEST_PRE_RELEASE_FKEY = Internal.createForeignKey(Extension.EXTENSION, DSL.name("extension_latest_pre_release_fkey"), new TableField[] { Extension.EXTENSION.LATEST_PRE_RELEASE_ID }, Keys.EXTENSION_VERSION_PKEY, new TableField[] { ExtensionVersion.EXTENSION_VERSION.ID }, true);
