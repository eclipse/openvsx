...
public class ExtensionRecord extends UpdatableRecordImpl<ExtensionRecord> implements Record9<Long, Double, Integer, String, Long, String, Boolean, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row9<Long, Double, Integer, String, Long, String, Boolean, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public ExtensionRecord values(Long value1, Double value2, Integer value3, String value4, Long value5, String value6, Boolean value7, LocalDateTime value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExtensionRecord(Long id, Double averageRating, Integer downloadCount, String name, Long namespaceId, String publicId, Boolean active, LocalDateTime publishedDate, LocalDateTime lastUpdatedDate) {
        super(Extension.EXTENSION);
