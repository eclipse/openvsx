...
public class ExtensionRecord extends UpdatableRecordImpl<ExtensionRecord> implements Record10<Long, Double, Integer, String, Long, Long, String, Boolean, Boolean, Long> {
    ...
    /**
     * Setter for <code>public.extension.preview</code>.
     */
    ...
    /**
     * Getter for <code>public.extension.preview</code>.
     */
    ...
    @Override
    public Row10<Long, Double, Integer, String, Long, Long, String, Boolean, Boolean, Long> valuesRow() {
    ...
    @Override
    public ExtensionRecord values(Long value1, Double value2, Integer value3, String value4, Long value5, Long value6, String value7, Boolean value8, Boolean value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExtensionRecord(Long id, Double averageRating, Integer downloadCount, String name, Long latestId, Long namespaceId, String publicId, Boolean active, Boolean preview, Long latestPreReleaseId) {
        super(Extension.EXTENSION);
