...
public class ExtensionVersion extends TableImpl<ExtensionVersionRecord> {
    ...
    /**
     * The column <code>public.extension_version.potentially_malicious</code>.
     */
    ...
    private ExtensionVersion(Name alias, Table<ExtensionVersionRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public ExtensionVersion where(Condition condition) {
        return new ExtensionVersion(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ExtensionVersion where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ExtensionVersion where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ExtensionVersion where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ExtensionVersion where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ExtensionVersion where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ExtensionVersion where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ExtensionVersion where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ExtensionVersion whereExists(Select<?> select) {
     ...
     */
    @Override
    public ExtensionVersion whereNotExists(Select<?> select) {
