...
public class JobrunrBackgroundjobservers extends TableImpl<JobrunrBackgroundjobserversRecord> {
    ...
    private JobrunrBackgroundjobservers(Name alias, Table<JobrunrBackgroundjobserversRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public JobrunrBackgroundjobservers where(Condition condition) {
        return new JobrunrBackgroundjobservers(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public JobrunrBackgroundjobservers where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public JobrunrBackgroundjobservers where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public JobrunrBackgroundjobservers where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public JobrunrBackgroundjobservers where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JobrunrBackgroundjobservers where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JobrunrBackgroundjobservers where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public JobrunrBackgroundjobservers where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public JobrunrBackgroundjobservers whereExists(Select<?> select) {
     ...
     */
    @Override
    public JobrunrBackgroundjobservers whereNotExists(Select<?> select) {
